...
@Configuration
@ComponentScan(/* basePackageClasses = Application.class */basePackages = { "my.pack" , "com.interview.questions.controller"}, includeFilters = @Filter(Controller.class), useDefaultFilters = false)
